...
var Sankey = (function (_super) {
    ...
    Sankey.renderNodeItem = function (option, props) {
        ...
        return react_1.default.createElement(Rectangle_1.Rectangle, __assign({ className: "recharts-sankey-node", fill: "#0088fe", fillOpacity: "0.8" }, (0, types_1.filterProps)(props)));
    };
    ...
    Sankey.prototype.render = function () {
        ...
        return (react_1.default.createElement("div", { className: (0, classnames_1.default)('recharts-wrapper', className), style: __assign(__assign({}, style), { position: 'relative', cursor: 'default', width: width, height: height }) },
