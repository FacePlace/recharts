...
var CartesianGrid = (function (_super) {
    ...
    CartesianGrid.prototype.renderVerticalStripes = function (verticalPoints) {
        ...
        var items = verticalPointsUpdated.map(function (entry, i) {
            ...
            return (react_1.default.createElement("rect", { key: "react-".concat(i), x: Math.round(entry + x - x), y: y, width: lineWidth, height: height, stroke: "none", fill: verticalFill[colorIndex], fillOpacity: fillOpacity, className: "recharts-cartesian-grid-bg" }));
        });
    ...
    CartesianGrid.prototype.renderHorizontalStripes = function (horizontalPoints) {
        ...
        var items = horizontalPointsUpdated.map(function (entry, i) {
            ...
            return (react_1.default.createElement("rect", { key: "react-".concat(i), y: Math.round(entry + y - y), x: x, height: lineHeight, width: width, stroke: "none", fill: horizontalFill[colorIndex], fillOpacity: fillOpacity, className: "recharts-cartesian-grid-bg" }));
        });
