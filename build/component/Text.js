...
var Text = (function (_super) {
    ...
    Text.prototype.render = function () {
        ...
        return (react_1.default.createElement("text", __assign({}, (0, types_1.filterProps)(textProps, true), { x: x, y: y, className: (0, classnames_1.default)('recharts-text', className), textAnchor: textAnchor }), wordsByLines.map(function (line, index) { return (react_1.default.createElement("tspan", { x: x, dy: index === 0 ? startDy : lineHeight, key: index }, line.words.join(breakAll ? '' : ' '))); })));
    };
    Text.defaultProps = {
        x: 0,
        y: 0,
