...
var Funnel = (function (_super) {
    ...
    Funnel.prototype.renderTrapezoidsStatically = function (trapezoids) {
        ...
        return trapezoids.map(function (entry, i) {
            ...
            return (react_1.default.createElement(Layer_1.Layer, __assign({ className: "recharts-funnel-trapezoid" }, (0, types_1.adaptEventsOfChild)(_this.props, entry, i), { key: "trapezoid-".concat(i) }), Funnel.renderTrapezoidItem(trapezoidOptions, trapezoidProps)));
        });
    };
