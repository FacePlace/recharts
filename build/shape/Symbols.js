...
var Symbols = (function (_super) {
    ...
    Symbols.prototype.render = function () {
        ...
        if (cx === +cx && cy === +cy && size === +size) {
            return (react_1.default.createElement("path", __assign({}, (0, types_1.filterProps)(this.props, true), { className: (0, classnames_1.default)('recharts-symbols', className), transform: "translate(".concat(cx, ", ").concat(cy, ")"), d: this.getPath() })));
        }
        return null;
    };
